...
# {{< anchor "Blockquotes" >}}Blockquotes
...
# {{< anchor "Horizontal" >}}Horizontal rule
...
![Super wide](https://placehold.co/1280x800)
{{< figure 
    src="https://placehold.co/1280x800"
    alt="alt-test"
...
![Not so big](https://placehold.co/400x400)
